...
CREATE TABLE `student` (
	...
	`st_status`	varchar(10) not null default '재학'	,
...
CREATE TABLE `major` (
	...
	`ma_state`	varchar(10) not	NULL,
	`ma_st_num`	varchar(10)	NOT NULL,
	`ma_de_num`	char(3)	NOT NULL default '전공'
);
...
CREATE TABLE `lecture` (
	...
	`le_schedule`	varchar(50)	not NULL default '', -- null 로하는것 보다 빈문자열로 하는것이 효과적이다
	`le_point`	int	not NULL default 0,
	`le_class`	int not NULL default 1,
	`le_year`	int not	NULL,
	`le_term`	varchar(10) not null, -- 여름학기,겨울학기..
