...
public class MethodBaseballGameEx01 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 1~9사이의 중복되지 않은 3개의 숫자가 랜덤으로 생성이 되고, 생성된 숫자를 맞추는 게임 규칙 
	...
	/**
	 * 기능 : Scanner가 주어지면 정수를 size개만큼 입력받아 배열에 저장하고, 저장된 배열을 돌려주는 메소드 매개변수 :
	 * Scanner, size개 => Scanner scan, int size 리턴타입 : 정수 배열 => int [] 메소드명 :
	 * scanArray
	 * 
	 * @param scan Scanner
