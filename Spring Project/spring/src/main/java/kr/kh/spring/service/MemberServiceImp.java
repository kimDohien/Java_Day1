...
public class MemberServiceImp implements MemberService {
	...
	private void sendEmail(String title, String content, String email) { //email은 받는사람
	    ...
	    try {
	        ...
	        //setText 에 true를 추가하면 , content에 있는 html코드를 html 코드로 적용
	...
	public boolean emailAuthenticationConfirm(MemberOKVO mok) {
		...
		System.out.println("DB에서 가져온 : "+dbMok);
		if(dbMok != null) { //null이 아니라는것은 있다는것
			//member_ok 테이블에서 해당 데이터 삭제
