...
public class CourseMapper implements CourseDAO {
	...
	public LectureVO selectLectueByName(String le_name, int le_class, int le_year, String le_term,
			String co_st_num) {
	...
	public void insertCourse(CourseVO courseVO) {
		String sql = "insert into course(co_st_num, co_le_num, co_type)values(?,?,?)";
		try {
			dbConnector.pstmt = dbConnector.con.prepareStatement(sql);
